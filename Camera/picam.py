...
filepath = "/home/pi/AutoSentry/Camera/pix"
...
def keepDiskSpaceFree(bytesToReserve):
    if (getFreeSpace() < bytesToReserve):
        zipfilename = filepath + "/../zip/" + filenamePrefix + "-%04d%02d%02d-%02d%02d%02d.zip" % (time.year, time.month, time.day, time.hour, time.minute, time.second)
        call(["zip", "-r", filepath, zipfilename]); 
